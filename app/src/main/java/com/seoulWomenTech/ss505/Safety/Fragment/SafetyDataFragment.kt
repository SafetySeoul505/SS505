package com.seoulWomenTech.ss505.Safety.Fragment
...
import com.seoulWomenTech.ss505.Safety.Adapter.SafetyResourceAdapter
import com.seoulWomenTech.ss505.DB.DAO.UserInfoDAO
...
import com.seoulWomenTech.ss505.Safety.Model.SafetyResourceModelClass
...
class SafetyDataFragment : Fragment() {
    ...
    fun addSaftyData(){
        // 임의의 데이터들
        safetydatalist.add(SafetyResourceModelClass(R.drawable.sdi_cpr, "심폐소생술 안전자료"))
        safetydatalist.add(SafetyResourceModelClass(R.drawable.sdi_video, "비디오 1 입니다."))
        safetydatalist.add(SafetyResourceModelClass(R.drawable.sdi_video, "비디오 2 입니다."))
    }
}
