package com.seoulWomenTech.ss505.Main.Fragment.Challenge
...
import com.seoulWomenTech.ss505.ChallengeClass
import com.seoulWomenTech.ss505.DB.DAO.ChallengeDAO
import com.seoulWomenTech.ss505.DB.DAO.CpiDAO
import com.seoulWomenTech.ss505.DB.DAO.ParticipantsDAO
...
class MyChallengeFragment : Fragment() {
    ...
    inner class MyChallengeActiveRecyclerViewAdapter : RecyclerView.Adapter<MyChallengeActiveRecyclerViewAdapter.MyChallengeActiveViewHolderClass>(){
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyChallengeActiveViewHolderClass {
        ...
        override fun onBindViewHolder(holder: MyChallengeActiveViewHolderClass, position: Int) {
    ...
    inner class MyChallengeDisabledRecyclerViewAdapter : RecyclerView.Adapter<MyChallengeDisabledRecyclerViewAdapter.MyChallengeDisabledViewHolderClass>(){
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyChallengeDisabledViewHolderClass {
            val rowChallengeBinding = RowChallengeBinding.inflate(layoutInflater)
        ...
        @RequiresApi(Build.VERSION_CODES.O)
        override fun onBindViewHolder(holder: MyChallengeDisabledViewHolderClass, position: Int) {
